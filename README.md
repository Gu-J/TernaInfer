...
This repository provides a highly efficient GEMV kernel implementation for the BitNet model. It is tailored for use with the [BitNet-b1.58-2B-4T](https://arxiv.org/abs/2504.12285) model.
